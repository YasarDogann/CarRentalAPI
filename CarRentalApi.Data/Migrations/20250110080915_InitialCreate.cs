        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Year = table.Column<int>(type: "int", nullable: false, defaultValue: 2025, comment: "Araç Üretim Yılı"),
                    VehicleType = table.Column<int>(type: "int", nullable: false),
                    PricePerDay = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0.0m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => new { x.CarId, x.UserId, x.PaymentId });
                    table.ForeignKey(
